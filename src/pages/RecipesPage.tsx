    ...
    <div className="max-w-6xl mx-auto p-2 sm:p-4 pb-24 md:pb-12 space-y-4">
      ...
      {selectedRecipe ? (
        <div className="space-y-4 animate-in fade-in duration-150">
          {/* Back button & Actions */}
          <div className="flex items-center justify-between glass-panel p-3.5 rounded-3xl border border-white/10">
            <button
              onClick={() => {
                setSelectedRecipe(null);
                setIsCookMode(false);
              ...
              className="flex items-center gap-2 text-xs font-bold text-slate-300 hover:text-white bg-slate-900/80 px-3.5 py-2 rounded-2xl border border-white/10 transition-colors"
            >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="bg-emerald-500 hover:bg-emerald-400 text-slate-950 px-4 py-2 rounded-2xl text-xs font-bold flex items-center gap-1.5 transition-all shadow-md shadow-emerald-500/20"
              >
              ...
              <button
                ...
                className="p-2 rounded-2xl bg-red-500/10 hover:bg-red-500/20 text-red-400 transition-colors"
              >
                    ...
                    <div
                      ...
                      className={`p-3 rounded-2xl flex items-center justify-between text-xs cursor-pointer transition-all ${
                        checkedIngredients[i]
                          ...
                          : 'bg-slate-900/60 hover:bg-slate-900/90 text-slate-200 border border-white/5'
                      }`}
                    >
                      <div className="flex items-center gap-2.5">
                        ...
                        <span className="font-medium selectable-text">{ing.item}</span>
                      </div>
                      {ing.amount && (
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-4 rounded-3xl glass-panel border border-white/10">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                Saved household recipes with 1-tap web import & Cook Mode
              </p>
            </div>

            <button
              onClick={() => setIsScraperOpen(true)}
              className="bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-400 hover:to-rose-400 text-white px-4 py-2 rounded-2xl text-xs font-bold flex items-center gap-2 transition-all shadow-lg shadow-pink-500/20"
            >
          ...
          {/* Search Bar */}
          <div className="glass-panel p-2 rounded-3xl border border-white/10 flex items-center gap-2">
            <Search className="w-4 h-4 text-slate-400 ml-2" />
            <input
              type="text"
              placeholder="Search recipes by title or tags (e.g. Pasta, Quick, Kids)..."
              value={searchQuery}
